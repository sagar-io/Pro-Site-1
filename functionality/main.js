...
function handleTab(e) {
    ...
    switch(this.id){
        case 'tab-1' :
          tab_container.style.background = !isSmallScreen ? `url("../images/vr-10-med.jpg") center` : `url("../images/vr-10-mobo.jpg") center`;
          tab_container.style.backgroundSize = `cover`;
          

        break;
        case 'tab-2' : 
          tab_container.style.background = !isSmallScreen ? `url("../images/vr-8-med.jpg") center` : `url("../images/vr-8-mobo.jpg") center`;
          tab_container.style.backgroundSize = `cover`;
        break;
        case 'tab-3' : 
          tab_container.style.background = !isSmallScreen ?  `url("../images/vr-11.jpg") center` : `url("../images/vr-11.jpg") center`;
          tab_container.style.backgroundSize = `cover`;
    }
}
